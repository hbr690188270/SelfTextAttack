...
from .my_attack.my_textfooler import MyTextFoolerJin2019
from .my_attack.my_bertattack import MyBERTAttackLi2020
from .my_attack.my_hotflip import MyHotFlipEbrahimi2017
from .my_attack.my_bae import MyBAEGarg2019