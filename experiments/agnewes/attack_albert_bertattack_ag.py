...
directory = '/mnt/cloud/bairu/repos/std_text_pgd_attack/checkpoints/albert-xxlarge-v2-ag'
...
attack_args = textattack.AttackArgs(num_examples = -1, log_to_txt = './log/bertattack_ag_albertxxlargev2.txt', query_budget = 500)
