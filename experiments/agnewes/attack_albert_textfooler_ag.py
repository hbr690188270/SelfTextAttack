...
directory = './../../../std_text_pgd_attack/checkpoints/albert-agnews/'
...
attack_args = textattack.AttackArgs(num_examples=-1, log_to_txt='./log/textfooler_ag_albertxxlargev2.txt',
                                    query_budget=500)
