...
directory = '/mnt/cloud/bairu/repos/std_text_pgd_attack/checkpoints/roberta-large-rte'
...
attack_args = textattack.AttackArgs(num_examples = -1, log_to_txt = './log/bertattack_qnli_robertalarge.txt', query_budget = 500)
