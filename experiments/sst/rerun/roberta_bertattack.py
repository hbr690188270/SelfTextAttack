...
def load_dataset_sst(path = '/mnt/cloud/bairu/repos/TextAttack/log/bertattack_sst_robertalarge_query2000.txt'):
...
with open("./attack_res/bertattack_roberta.pkl", 'wb') as f:
