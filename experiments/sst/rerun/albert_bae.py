...
def load_dataset_sst(path = '/mnt/cloud/bairu/repos/TextAttack/log/bae_sst_albertxxlargev2.txt'):
...
attack_args = textattack.AttackArgs(num_examples = -1, log_to_txt = './log/rerun/bae_sst_albertxxlargev2.txt', query_budget = 40)
...
with open("./attack_res/bae_albert.pkl", 'wb') as f:
