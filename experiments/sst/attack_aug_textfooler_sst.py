...
directory = '/mnt/cloud/bairu/repos/TextDefender/checkpoints/bert-base-aug-sst'
...
attack_args = textattack.AttackArgs(num_examples = -1, log_to_txt = './log/textfooler_sst_aug_query2000.txt', query_budget = 2000)
