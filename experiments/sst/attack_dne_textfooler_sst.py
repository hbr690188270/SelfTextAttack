...
directory = '/mnt/cloud/bairu/repos/TextDefender/checkpoints/bert-base-dne-sst'
...
attack_args = textattack.AttackArgs(num_examples = -1, log_to_txt = './log/textfooler_sst_dne_query2000.txt', query_budget = 2000)
