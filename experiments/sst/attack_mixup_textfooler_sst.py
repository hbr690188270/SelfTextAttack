...
from textattack.models.self_models import MixText
...
directory = '/mnt/cloud/bairu/repos/TextDefender/checkpoints/bert-base-mixup-sst'
model = MixText.from_pretrained(directory)
...
attack_args = textattack.AttackArgs(num_examples = -1, log_to_txt = './log/textfooler_sst_mixup_query2000.txt', query_budget = 2000)
