...
directory = '/mnt/cloud/bairu/repos/TextDefender/checkpoints/bert-base-pgd-sst'
...
attack_args = textattack.AttackArgs(num_examples = -1, log_to_txt = './log/bertattack_sst_pgd_query2000.txt', query_budget = 2000)
