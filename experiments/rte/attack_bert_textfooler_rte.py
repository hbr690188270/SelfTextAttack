...
directory = '/mnt/cloud/bairu/repos/std_text_pgd_attack/checkpoints/bert-base-mnli'
...
attack_args = textattack.AttackArgs(num_examples = -1, log_to_txt = './log/textfooler_rte_bertbase.txt', query_budget = 500)
